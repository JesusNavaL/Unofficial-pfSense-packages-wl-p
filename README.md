...
```fetch -q -o /usr/local/etc/pkg/repos/Packages.conf https://raw.githubusercontent.com/JesusNavaL/Unofficial-pfSense-packages-wl/master/Packages.conf```

pfSense 2.4 amd64:

```fetch -q -o /usr/local/etc/pkg/repos/Packages.conf https://raw.githubusercontent.com/JesusNavaL/Unofficial-pfSense-packages-wl/master/Packages.24.conf```
